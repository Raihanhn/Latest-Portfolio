    ...
    <section className='section' id='about' ref={ref} >
      <div className="container mx-auto">
        <div className=" flex flex-col gap-y-10 mt-[50px]  lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen  ">
          <motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.3}}  className="  block md:hidden lg:block flex-1 bg-about bg-contain bg-no-repeat min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[620px] mix-blend-lighten bg-top "></motion.div>
